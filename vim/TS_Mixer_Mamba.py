...
class Temporal_Mixer_4MSTCT(nn.Module):
    def __init__(self, inter_channels, embedding_dim):
        super().__init__()
        # c1_in_channels, c2_in_channels, c3_in_channels= inter_channels
    ...
    def forward(self, x):
        ...
        # _f2_n = self.linear2(_f3) + _f2
        # _f1_n = self.linear3(_f3) + _f1

        # concat_feature=torch.cat([_f3, _f2_n, _f1_n], dim=1)

        return concat_feature
    
class Temporal_Mixer_3MSTCT(nn.Module):
    def __init__(self, inter_channels, embedding_dim):
        super().__init__()
        c1_in_channels, c2_in_channels, c3_in_channels= inter_channels
